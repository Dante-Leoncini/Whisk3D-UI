...
PropColor::PropColor(const std::string& Name):
    PropertieBase(Name){
    value = NULL;
    palRef = NULL; palObj = NULL;  // sin contexto de paleta (el bind del editor lo setea)
    animProp = -1; animComp = 0;   // sin rombo por defecto (se activa desde el panel: AnimColor)
};
