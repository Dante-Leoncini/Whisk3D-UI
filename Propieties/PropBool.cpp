...
void PropBool::RenderPropertiBox(Card* propertiBox){
    if (value){
        float dx = (float)(width - PropColEtiqueta - propertiBox->width - bordersGS - g_propKeyBtnCol);
...
void PropBool::RenderPropertiValue(Card* propertiBox){
    if (value){
        ...
        float dx = (float)(width - PropColEtiqueta - cb - bordersGS - borderGS - g_propKeyBtnCol);
        w3dEngine::Translatef(dx, 0, 0);
...
void PropBool::RenderPropertiLabel(Card* propertiBox){
    if (value){
        ...
        float dx = (float)(width - PropColEtiqueta - cb - bordersGS - gapGS - g_propKeyBtnCol);
        int wLabel = width - cb - bordersGS - gapGS * 2 - g_propKeyBtnCol;
        w3dEngine::Translatef(dx, 0, 0);
